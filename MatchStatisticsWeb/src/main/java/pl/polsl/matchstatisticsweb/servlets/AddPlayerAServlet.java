...
/**
 * Servlet used to add new players to team A
 * @author Jedrzej Piaskowski
 * @version 4.0
 */
public class AddPlayerAServlet extends HttpServlet {

    /**
     * method that adds player to team A
     * 
    ...
    public void processRequest(HttpServletRequest request, 
        ...
        try {
            match.getTeamA().addPlayer(request.getParameter("playerAName"),
                    parseInt(request.getParameter("shotsA")),
                    parseInt(request.getParameter("shotsOnTargetA")));
